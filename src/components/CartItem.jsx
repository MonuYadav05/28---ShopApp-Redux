        ...
        <div className="w-[70%] self-start space-y-5 ml-5">
          ...
          <div>
            {readMore ? (
              ...
              <p className="text-base text-slate-700 font-medium md:hidden">
            ...
            >
              {readMore ? <p>less</p> : <p>read more</p>}
            </button>
          </div>
          <p className="text-base text-slate-700 font-medium hidden md:block">
            {item.description}
          </p>
