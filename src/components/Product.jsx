...
const Product = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center border justify-between bg-white sm:hover:scale-110 transition-all duration-300  ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] md:hover:shadow-[0px_0px_95px_53px_#00000024]  ">
      <div>
