...
const Cart = () => {
  ...
  return (
    <div className="mb-10">
      {cart.length > 0 ? (
        <div className="md:flex flex-row justify-center md:max-[1300px] mx-auto gap-x-5">
          {/* Cart Item  */}
          ...
          {/* Summary */}
          <div className="md:w-[40%] md:mt-5 flex flex-col">
            <div className="flex flex-col h-[100%] justify-between p-5 md:gap-5 md:my-14">
            ...
            <div className="flex flex-col">
              <p className="text-xl mx-5 font-bold">
                <span className="text-gray-700 font-semibold">
                  Total Amount:
                </span>{" "}
                ${amount}
              </p>
              <button className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mx-5 md:mr-10">
                CheckOut Now
              </button>
            </div>
          </div>
